...
import org.feuyeux.rsocket.pojo.UserToken;
...
public class TokenUtils {
     ...
     * As 1 character = 8 bits, the length of the characters should be more than 32.
     *
    ...
    private static final Algorithm ACCESS_ALGORITHM = Algorithm.HMAC256(ACCESS_SECRET_KEY);
    private static final Algorithm REFRESH_ALGORITHM = Algorithm.HMAC256(REFRESH_SECRET_KEY);
    private static final MacAlgorithm MAC_ALGORITHM = MacAlgorithm.HS256;
    private static final String HMAC_SHA_256 = "HmacSHA256";

    public static UserToken generateToken(HelloUser user, Algorithm algorithm, long expire, ChronoUnit unit) {
    ...
    public static ReactiveJwtDecoder jwtRefreshTokenDecoder() {
